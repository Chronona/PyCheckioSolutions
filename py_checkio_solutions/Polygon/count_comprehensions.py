#!/usr/local/bin/checkio --domain=py run count-comprehensions

# You have to write a function that receives a python source code,    count list/set/dict/generator comprehensions, and returns these counts.
# List comprehensions, set comprehensions, dict comprehensions, generator expressions    are respectively represented by "ListComp", "SetComp", "DictComp", "GeneratorExp"    in the results dictionary.
# 
# Input:A string.
