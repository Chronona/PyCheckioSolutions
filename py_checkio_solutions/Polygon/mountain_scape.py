#!/usr/local/bin/checkio --domain=py run mountain-scape

# You are given the coordinates of the top of the triangle as input values.The slope angle is 45 degrees.The base is always on the x-axis.You must return the total area of all triangles.But count the overlapping areas only once.
# 
